...
test('It should get OSX platform for Sonoma', () => {
  // Given
  const userAgent = 'Chrome 125.0.0.0 / Sonoma 14';
...
test('It should get Linux platform for Debian', () => {
  // Given
  const userAgent = 'Chrome 125.0.0.0 / Debian 12.5';
